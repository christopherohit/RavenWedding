...
namespace Telerik.Examples.WinControls.Spreadsheet.Printing
{
    ...
    {
        private const string SampleDocumentPath = @"..\Spreadsheet\SampleData\Printing.xlsx";
        ...
        public Form1()
        {
            ...
            this.radSpreadsheetRibbonBar1.RibbonBarElement.TabStripElement.SelectedItem = this.radSpreadsheetRibbonBar1.RibbonBarElement.TabStripElement.Items[2];
