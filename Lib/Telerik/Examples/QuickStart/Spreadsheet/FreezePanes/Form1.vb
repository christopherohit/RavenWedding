...
Namespace Telerik.Examples.WinControls.Spreadsheet.FreezePanes
    Partial Public Class Form1
        ...
        Private Const SampleDocumentPath As String = "..\Spreadsheet\SampleData\FreezePanes.xlsx"
        ...
        Public Sub New()
            ...
            Me.radSpreadsheetRibbonBar1.RibbonBarElement.TabStripElement.SelectedItem = Me.radSpreadsheetRibbonBar1.RibbonBarElement.TabStripElement.Items(5)
