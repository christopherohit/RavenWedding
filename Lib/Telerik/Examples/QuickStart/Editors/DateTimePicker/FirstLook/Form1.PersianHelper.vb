...
Namespace Telerik.Examples.WinControls.Editors.DateTimePicker.FirstLook
    ...
    Public Class InvokeHelper
        ...
        Public Function InvokeByRef(MethodName As String, ByRef args As Object(), modifiers As ParameterModifier) As Object
            ...
            Return Me.m_Type.InvokeMember(MethodName, BindingFlags.NonPublic Or BindingFlags.[Public] Or BindingFlags.Instance Or BindingFlags.InvokeMethod, Nothing, Me.m_Instance, args, [mod],
                Nothing, Nothing)
        End Function
    ...
    Friend Class PersianCultureHelper
        ...
        Public Shared Function FixPersianDateTimeFormat(info As DateTimeFormatInfo, UsePersianCalendar As Boolean) As DateTimeFormatInfo
            ...
            If (info.Calendar.GetType() Is GetType(PersianCalendar)) Then
                info.AbbreviatedDayNames = New String() {"ی", "د", "س", "چ", "پ", "ج",
                    "ش"}
                info.ShortestDayNames = New String() {"ی", "د", "س", "چ", "پ", "ج",
                    "ش"}
                info.DayNames = New String() {"یکشنبه", "دوشنبه", "ﺳﻪشنبه", "چهارشنبه", "پنجشنبه", "جمعه",
                    "شنبه"}
                info.AbbreviatedMonthNames = New String() {"فروردین", "ارديبهشت", "خرداد", "تير", "مرداد", "شهریور",
                    "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند",
                    ""}
                info.MonthNames = New String() {"فروردین", "ارديبهشت", "خرداد", "تير", "مرداد", "شهریور",
                    "مهر", "آبان", "آذر", "دی", "بهمن", "اسفند",
                    ""}
