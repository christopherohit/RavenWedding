Namespace Telerik.Examples.WinControls.ChartView.ChartTypes.LineAndArea
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.radDropDownList1.Location = New Point(5, 69)
			...
			Me.radLabel2.Location = New Point(3, 107)
			...
			Me.radDropDownList2.Location = New Point(5, 131)
			...
			Me.radCheckBox1.Location = New Point(5, 169)
