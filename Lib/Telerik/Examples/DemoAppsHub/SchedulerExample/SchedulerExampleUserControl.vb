...
Namespace DemoAppsHub.SchedulerExample
	Public Partial Class SchedulerExampleUserControl
		...
		Public Sub New()
			InitializeComponent()
			Me.radSchedulerNavigator1.AutomaticNavigation = False
			Me.radScheduler1.ThemeName = "TelerikMetroBlue"
			Me.radSchedulerNavigator1.ThemeName = "TelerikMetroBlue"
			Me.radScheduler1.ActiveViewType = SchedulerViewType.Month
			Me.radScheduler1.BringToFront()
			FillSchedulerAppointments()
		End Sub

		Private Sub FillSchedulerAppointments()
			Dim backInfo As AppointmentBackgroundInfo = New AppointmentBackgroundInfo(15, "White", Color.White, Color.White)
			...
			For Each info As AppointmentBackgroundInfo In Me.radScheduler1.Backgrounds
			...
			Dim appointmentTime As DateTime = New DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 9, 0, 0)

			Me.radScheduler1.Appointments.BeginUpdate()

			Dim appointment As Appointment = New Appointment(appointmentTime, TimeSpan.FromHours(3), Telerik.WinControls.VersionNumber.MarketingVersion & " Release", "Description")
